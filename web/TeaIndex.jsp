...
<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #1aa094;">
        ...
        <div class="layui-main">
            <div class="admin-login-box">
                <a class="logo" style="left: 0;" href="index.jsp">
                    <span style="font-size: 18px;">工作室文件管理系统</span>
                </a>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/datas/navtea.js"></script>
    <script src="${pageContext.request.contextPath}/js/teaindex.js"></script>
    <script>
